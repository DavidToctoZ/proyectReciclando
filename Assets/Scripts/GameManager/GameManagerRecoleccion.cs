...
public class GameManagerRecoleccion : MonoBehaviour
{
    ...
    public static List<Dictionary<string, string>> listObjetosRecolectados = new List<Dictionary<string, string>>();
